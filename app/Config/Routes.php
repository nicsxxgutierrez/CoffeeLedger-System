...
$routes->post('/adminregister', 'AdminController::adminregister');
$routes->get('/adminhome', 'AdminController::home');
$routes->get('/admindash', 'AdminController::dashboard');
$routes->get('/admininventory', 'AdminController::inventory');
$routes->get('/adminorder', 'AdminController::order');
$routes->get('/adminhistory', 'AdminController::gethistory');
$routes->get('/adminmanage_user', 'AdminController::getmanageuser');
$routes->get('/adminmnguser', 'AdminController::mnguser');
$routes->post('/adminadduser', 'AdminController::adduser');
...
$routes->get('/logout', 'AdminController::adminlogout', ['filter'=>'authFilter']);
                    /* For Inventory */
